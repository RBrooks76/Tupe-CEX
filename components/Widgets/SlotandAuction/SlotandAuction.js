...
import SlotandAuctionRow from './SlotandAuctionRow';

const SlotandAuction = memo(() => {
  ...
  return (
    <Box>
      ...
      <div className='box-content box-content-height'>
        {data && data.map((item) => <SlotandAuctionRow key={item.id.toString()} item={item} />)}
      </div>
      <div className='box-button box-vertical-padding box-horizontal-padding'>
        <Link href='/exchange' className='button button-purple button-medium button-block'>
          <span>
            More

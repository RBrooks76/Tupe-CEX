...
const SlotandAuctionRow = memo(({ item }) => {
  ...
  return (
    <div className='exchange-row flex flex-center flex-space-between'>
      <div>
...
SlotandAuctionRow.propTypes = {
  // eslint-disable-next-line react/forbid-prop-types
  item: PropTypes.object.isRequired,
};

export default SlotandAuctionRow;

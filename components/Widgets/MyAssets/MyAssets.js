...
const MyAssets = memo(() => {
  ...
  return (
    <Box>
      <div className='flex'>
        <div className='flex-start px-4 py-2 mt-2 content-md-30 flex-1'>
          <input type='text' placeholder='Search Coins' className='seach-ipt' />
        </div>
        <div className='flex-end px-4 py-2 mt-2'>
          <Link href='/' type='button' className='button button-purple button-small'>
            Crypto To
          </Link>
        </div>
      </div>
      <table className='box-title box-vertical-padding box-horizontal-padding no-select h-auto mt-2'>
        <thead>
          <tr>
            <th>Coin</th>
            <th>Balance</th>
        ...
        <tbody className='box-content box-content-height-nobutton'>
